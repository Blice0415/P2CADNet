...
class ConfigAE(object):
    ...
    def parse(self):
        ...
        parser.add_argument('--exp_name', type=str, default="pretrained", help="name of this experiment")
        parser.add_argument('-g', '--gpu_ids', type=str, default='0', help="gpu to use, e.g. 0  0,1,2. CPU not supported.")
        parser.add_argument('--raw_root', type=str, default="path_to_data", help="path to data folder")
        ...
        parser.add_argument('--ckptpc', type=str, default='latest', required=False, help="desired checkpoint to restore")
        ...
        parser.add_argument('--ckpt', type=str, default=1000, required=False, help="desired checkpoint to restore")
