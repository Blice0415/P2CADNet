'''
This is a well-known issue, I finally managed to duplicate it on my machine. I found a fix, but I have to ensure it also works on your side. Can you please open the file F:\zapoye\anaconda3\envs\pyocc\lib\site-packages\OCC\Display\qtDisplay.py, and change the line 38 from:
...
for path in out_paths:
    ...
    write_stl_file(out_shape, filename="tmp_out_name.stl")
    # print("111")
